...
public class p1 {
    public static void main(String[] args) {
        ...
        try {
            ...
            Thread cst = new Thread(new ClientServiceThread(new I2NPSocket(6969, InetAddress.getByName("127.0.0.1")), 2000));
            router.run();
            cst.run();

            //this will be our client stuff following
            I2CPSocket sock = new I2CPSocket();
            //sock.sendMessage(new CreateSession());
        }
        catch(Exception e) {
            e.printStackTrace();
        }
