...
public class TunnelHopInfo implements JSONSerializable {
    ...
    byte[] layerIv; // AES IV for that hop
     ...
     * @param sendTunnelId
     */
    public TunnelHopInfo(byte[] routerHash, SecretKey layerKey, byte[] layerIv, SecretKey ivKey, int sendTunnelId) {
    ...
    public JSONType toJSONType() {
        ...
        jsonObject.put("layerIv", Base64.toBase64String(layerIv));
