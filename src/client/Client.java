...
public class Client {
    ...
    public static void processArgs(String[] args) throws IOException, InterruptedException {
        OptionParser parser;
        ...
        while (true) {
            ...
            switch (usercase) {
                ...
                case 2 -> {
                    ...
                    System.out.print("Please enter the size of the song: ");
                    int size = input.nextInt();
                    System.out.println("Please enter the songs file path: ");
                    String filePath = input.nextLine();

                    Request request = new Request("Add", clientHash, songname, size);
                    SendMessage msg = new SendMessage(sessionID, currDest, new byte[4], request.toJSONType());
                    socket.sendMessage(msg);
    ...
    private static void sendSong(Destination currDest, String filePath) {
        ...
        List<byte[]> chunks = chunkAudioData(audioBytes, 256); // 256 bytes per chunk
