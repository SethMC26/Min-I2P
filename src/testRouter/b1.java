...
public class b1 {
    public static void main(String[] args) {
        ...
        try {
            ...
            RouterInfo routerInfo = new RouterInfo(routerID, System.currentTimeMillis(), "127.0.0.1", 8082, signingprivKey);

            NetDB netDB = new NetDB(routerInfo);
            I2NPSocket sock = new I2NPSocket( 8082, InetAddress.getByName("127.0.0.1"));
